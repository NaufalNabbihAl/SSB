            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Pelatih</h6>
                        <form class="d-none d-md-flex ms-4" method="GET" action="{{ route('admin.coach') }}">
                            <input class="form-control border-0" type="search" placeholder="Search" name="search">
                            <button type="submit" class="btn btn-primary">Search</button>
                        </form>
                        <a href="{{route('admin.coach.create')}}" class="btn btn-primary">Tambah Pelatih</a>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-primary" href="{{route('admin.coach.edit',[$c ->id])}}">Detail</a>
                                        <form action="{{ route('admin.coach.delete', $c->id) }}" method="POST" style="display:inline;" class="delete-form">
                                        @csrf
                                        @method('DELETE')
