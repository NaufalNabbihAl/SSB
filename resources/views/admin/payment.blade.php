        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('admin.payment')}}" class="nav-item nav-link active">Pembayaran</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <form class="d-none d-md-flex ms-4" method="GET" action="{{ route('admin.payment') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($c->bukti_pembayaran)
                                            <img src="{{ asset('storage/' . $c->bukti_pembayaran) }}" alt="Bukti Pembayaran" style="width: 100px; height: auto;" class="img-thumbnail payment-proof" data-bs-toggle="modal" data-bs-target="#paymentProofModal" data-bs-src="{{ Storage::url('' . $c->bukti_pembayaran) }}">
                                        @else
                                    ...
                                    <td>{{ $c->deskripsi }}</td>
                                    <td>
                                        <form action="{{ route('admin.payment.delete', $c->id) }}" method="POST" style="display:inline;" class="delete-form">
                                            @csrf
                                            @method('DELETE')
